              ...
              <ul class="sidebar-menu" data-widget="tree">
                ...
                @else
                  @if (Auth::user()->type == 'admin')
                    <li class="active"><a href="/dashboard"><i class="fa fa-bar-chart"></i> <span>Dashboard</span></a></li>
                    <li class="active"><a href="/admin/users"><i class="fa fa-user"></i> <span>Users</span></a></li>
                    ...
                    <li class="active"><a href="/admin/reports"><i class="fa fa-binoculars"></i> <span>Reports</span></a></li>
                  ...
                  @else
                    ...
                    <li class="active"><a href="/reports"><i class="fa fa-binoculars"></i> <span>Reports</span></a></li>
                  @endif
                @endguest
