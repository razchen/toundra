	...
	<div class="col-lg-6">
		<div class="box box-info">
			...
			<div class="box-footer">
				<a href="/control-definitions/{{ $control_definition->id }}/edit" class="btn btn-primary">Edit</a>
				<form action="/control-definitions/{{ $control_definition->id }}" method="post" style="display:inline">
					@csrf
					@method('DELETE')
